            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($department->cover)
                            <img src="{{ asset('admin-assets/img/department/'.$department->cover) }}" alt="{{ $department->name }}" class="img-thumbnail" width="100px">
                            @else
                            <img src="{{ asset('admin-assets/img/no-image.jpg') }}" alt="{{ $department->name }}" class="img-thumbnail" width="100px">
                            @endif
                        </td>
                        ...
                        <td class="d-flex gap-1">
                            <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#edit{{ $department->id }}">
                                <i class="fa-solid fa-pen"></i>
                            </button>
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#delete{{ $department->id }}">
                                <i class="fa-solid fa-trash"></i>
                            </button>
                            <a href="{{ route('admin.department-questions.index',$department) }}" class="btn btn-primary btn-sm">
                                أضف سؤال
                            </a>
