  ...
  <div class="content_view">
    <form action="{{ route('admin.vendors.update',$vendor->id) }}" method="POST" enctype="multipart/form-data"
      ...
      <div class="row row-gap-24">
        ...
        {{-- <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <select name="type" class="form-control"  >
                        ...
                        <option value="vendor" {{ old('type',$vendor->type) == 'vendor' ? 'selected' : null }}>عميل
        </option>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        ...
        <input type="text" name="merchant_address" class="form-control"
          value="{{ old('merchant_address',$vendor->merchant_address) }}">
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        ...
        <select name="country_id" class="form-control">
          ...
          <option value="{{ $country->id }}" {{ old('country_id',$vendor->country_id)==$country->id?'selected':null }}>
            {{ $country->name }}</option>
          @endforeach
        </select>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        ...
        <select name="city_id" class="form-control">
          ...
          <option value="{{ $city->id }}" {{ old('city_id',$vendor->city_id)==$city->id?'selected':null }}>
            {{ $city->name }}</option>
          @endforeach
        </select>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        ...
        <select name="department_id" class="form-control">
          ...
          <option value="{{ $department->id }}"
            {{ old('department_id',$vendor->department_id)==$department->id?'selected':null }}>{{ $department->name }}
          </option>
          @endforeach
        </select>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        ...
        <input type="text" name="commercial_no" class="form-control"
          value="{{ old('commercial_no',$vendor->commercial_no) }}">
        @error('commercial_no')<span class="text-danger">{{ $message }}</span>@enderror
      </div>
      <div class="col-sm-6 col-md-4 col-lg-3">
        <label for="" class="small-label">السجل الضريبي</label>
        <input type="text" name="tax_id" class="form-control" value="{{ old('tax_id',$vendor->tax_id) }}">
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        ...
        <input type="text" name="maarouf_link" class="form-control"
          value="{{ old('maarouf_link',$vendor->maarouf_link) }}">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <script
              src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAxwLwv3e6VKoTTf0IpD9KDwP-9SyIZ7ds&callback=initMap"
              async defer></script>
            <script>
            function initMap() {
